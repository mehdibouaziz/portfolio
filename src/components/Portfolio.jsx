...
const Portfolio = () => {
    ...
    const projects = {
        recipeapp: {
            ...
            name: 'Recipe App',
            txt: 'Recipe catalog created with React for my own use. Includes a search engine and dark/light modes. WIP: JSON generator to add new recipes to the catalog',
            links: [
